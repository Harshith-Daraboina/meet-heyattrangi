    ...
    <main className="relative min-h-screen flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-8 text-white">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/10">
              <Image src="/images/logo-main.png" alt="Hey Attrangi" width={32} height={32} className="w-8 h-8 object-contain" />
              <span className="font-semibold text-sm tracking-wide uppercase text-[#FFD285]">Mental Health Reimagined</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-light max-w-2xl leading-relaxed drop-shadow-md">
        ...
        <div className="lg:col-span-5 flex justify-center lg:justify-end">
          <div className="w-full max-w-md bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl relative overflow-hidden group">
            ...
            <p className="text-white/60 mb-8 relative z-10">Enter your details to join the session</p>

            <form onSubmit={goToLobby} className="space-y-6 relative z-10">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-5 py-4 rounded-2xl bg-black/20 border border-white/10 text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-[#FF6A2D] focus:border-transparent transition-all backdrop-blur-sm"
                />
              </div>
              ...
              <button className="w-full bg-[#FF6A2D] hover:bg-[#ff5500] text-white text-lg py-4 rounded-2xl font-bold tracking-wide shadow-lg shadow-[#FF6A2D]/20 transform transition-all active:scale-[0.98] flex items-center justify-center gap-2">
                Continue <ArrowRightIcon />
              </button>
            </form>

            <div className="mt-8 pt-6 border-t border-white/10 text-center">
              <p className="text-xs text-white/40 uppercase tracking-widest font-semibold">Secure • Private • Encrypted</p>
            </div>
          </div>
        </div>
